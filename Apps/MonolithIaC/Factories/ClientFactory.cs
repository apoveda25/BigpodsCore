...
{
    public static Pulumi.Keycloak.OpenId.Client Build(
        string name,
        Pulumi.Keycloak.OpenId.ClientArgs args
    )
    {
        return new Pulumi.Keycloak.OpenId.Client(
            name,
            new()
            {
                ...
                BackchannelLogoutRevokeOfflineSessions =
                    args.BackchannelLogoutRevokeOfflineSessions,
                // ExtraConfig =
                // {
                //     { "string", "any" },
                // },
                ...
                ValidPostLogoutRedirectUris =
                    args.ValidPostLogoutRedirectUris ?? new List<string>(),
