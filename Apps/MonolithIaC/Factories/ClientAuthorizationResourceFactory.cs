...
{
    public static Pulumi.Keycloak.OpenId.ClientAuthorizationResource Build(string name, Pulumi.Keycloak.OpenId.ClientAuthorizationResourceArgs args)
    {
        return new Pulumi.Keycloak.OpenId.ClientAuthorizationResource(name, new()
        {
