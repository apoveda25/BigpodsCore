...
public sealed record RealmsData
{
    ...
    public static Dictionary<string, Realm> GetRealms()
    {
        ...
        return new()
        {
            [BigpodsName] = new Realm(
                Name: $"realms:{bigpodsNameKebabCase}",
                Config: new()
                {
                    ...
                    {
                        BruteForceDetection =
                            new Pulumi.Keycloak.Inputs.RealmSecurityDefensesBruteForceDetectionArgs
                            {
