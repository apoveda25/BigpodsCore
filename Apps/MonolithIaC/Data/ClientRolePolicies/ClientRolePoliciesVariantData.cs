...
{
    public static string VariantsCreateOneName { get; } = $"{ClientAuthorizationResourcesData.VariantsName}:{ClientAuthorizationScopesData.CreateOneName}";
    public static string VariantsCreateManyName { get; } = $"{ClientAuthorizationResourcesData.VariantsName}:{ClientAuthorizationScopesData.CreateManyName}";
    public static string VariantsReadOneName { get; } = $"{ClientAuthorizationResourcesData.VariantsName}:{ClientAuthorizationScopesData.ReadOneName}";
    public static string VariantsReadManyName { get; } = $"{ClientAuthorizationResourcesData.VariantsName}:{ClientAuthorizationScopesData.ReadManyName}";
    public static string VariantsUpdateOneName { get; } = $"{ClientAuthorizationResourcesData.VariantsName}:{ClientAuthorizationScopesData.UpdateOneName}";
    public static string VariantsUpdateManyName { get; } = $"{ClientAuthorizationResourcesData.VariantsName}:{ClientAuthorizationScopesData.UpdateManyName}";
    public static string VariantsDeleteOneName { get; } = $"{ClientAuthorizationResourcesData.VariantsName}:{ClientAuthorizationScopesData.DeleteOneName}";
    public static string VariantsDeleteManyName { get; } = $"{ClientAuthorizationResourcesData.VariantsName}:{ClientAuthorizationScopesData.DeleteManyName}";
    ...
    )
    {
        ...
        {
            [VariantsCreateOneName] = new ClientRolePolicy(Name: $"policies:{variantsCreateOneNameKebabCase}", Config: new()
            {
            ...
            [VariantsCreateManyName] = new ClientRolePolicy(Name: $"policies:{variantsCreateManyNameKebabCase}", Config: new()
            {
                RealmId = bigpodsRealm.Id.Apply(id => id),
                ResourceServerId = bigpodsMonolithAPIClient.Id.Apply(id => id),
                Roles = new[] {
            ...
            [VariantsReadOneName] = new ClientRolePolicy(Name: $"policies:{variantsReadOneNameKebabCase}", Config: new()
            {
                RealmId = bigpodsRealm.Id.Apply(id => id),
                ResourceServerId = bigpodsMonolithAPIClient.Id.Apply(id => id),
                Roles = new[] {
            ...
            [VariantsReadManyName] = new ClientRolePolicy(Name: $"policies:{variantsReadManyNameKebabCase}", Config: new()
            {
                RealmId = bigpodsRealm.Id.Apply(id => id),
                ResourceServerId = bigpodsMonolithAPIClient.Id.Apply(id => id),
                Roles = new[] {
            ...
            [VariantsUpdateOneName] = new ClientRolePolicy(Name: $"policies:{variantsUpdateOneNameKebabCase}", Config: new()
            {
                RealmId = bigpodsRealm.Id.Apply(id => id),
                ResourceServerId = bigpodsMonolithAPIClient.Id.Apply(id => id),
                Roles = new[] {
            ...
            [VariantsUpdateManyName] = new ClientRolePolicy(Name: $"policies:{variantsUpdateManyNameKebabCase}", Config: new()
            {
                RealmId = bigpodsRealm.Id.Apply(id => id),
                ResourceServerId = bigpodsMonolithAPIClient.Id.Apply(id => id),
                Roles = new[] {
            ...
            [VariantsDeleteOneName] = new ClientRolePolicy(Name: $"policies:{variantsDeleteOneNameKebabCase}", Config: new()
            {
                RealmId = bigpodsRealm.Id.Apply(id => id),
                ResourceServerId = bigpodsMonolithAPIClient.Id.Apply(id => id),
                Roles = new[] {
            ...
            [VariantsDeleteManyName] = new ClientRolePolicy(Name: $"policies:{variantsDeleteManyNameKebabCase}", Config: new()
            {
                RealmId = bigpodsRealm.Id.Apply(id => id),
                ResourceServerId = bigpodsMonolithAPIClient.Id.Apply(id => id),
                Roles = new[] {
