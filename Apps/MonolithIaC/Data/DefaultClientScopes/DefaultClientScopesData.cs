...
public sealed record ClientDefaultScope(string Name, Pulumi.Keycloak.OpenId.ClientDefaultScopesArgs Config);

public class ClientDefaultScopesData
{
    public static string ClientDefaultScopesName { get => string.Join(":", Scopes); }
    private static string[] Scopes { get; } = new[] {
    ...
    )
    {
        ...
        {
            [ClientDefaultScopesName] = new ClientDefaultScope(Name: $"client-default-scopes:{defaultScopesNameKebabCase}", Config: new()
            {
