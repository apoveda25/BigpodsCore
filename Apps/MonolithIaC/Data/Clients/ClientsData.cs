...
public static class ClientsData
{
    ...
    )
    {
        ...
        string bigpodsMonolithAPIClientNameKebabCase = StringUtils.ToKebabCase(
            BigpodsMonolithAPIClientName
        );

        return new Dictionary<string, Client>
        {
            [BigpodsGUIAPIClientName] = new Client(
                Name: $"clients:{bigpodsGUIAPIClientNameKebabCase}",
                Config: new()
                {
            ...
            [BigpodsMonolithAPIClientName] = new Client(
                Name: $"clients:{bigpodsMonolithAPIClientNameKebabCase}",
                Config: new()
                {
