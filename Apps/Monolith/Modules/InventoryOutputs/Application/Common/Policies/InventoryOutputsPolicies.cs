...
public sealed class InventoryOutputsPolicies
{
    ...
    private static readonly IBasePolicy CreateOneInventoryOutputs = new CreateOnePolicy(
        Name: CreateOneInventoryOutputsPolicy,
        Resource: Resource
    );
    private static readonly IBasePolicy UpdateOneInventoryOutputs = new UpdateOnePolicy(
        Name: UpdateOneInventoryOutputsPolicy,
        Resource: Resource
    );
    private static readonly IBasePolicy DeleteOneInventoryOutputs = new DeleteOnePolicy(
        Name: DeleteOneInventoryOutputsPolicy,
        Resource: Resource
    );
    private static readonly IBasePolicy ReadOneInventoryOutputs = new ReadOnePolicy(
        Name: ReadOneInventoryOutputsPolicy,
        Resource: Resource
    );
    private static readonly IBasePolicy ReadManyInventoryOutputs = new ReadManyPolicy(
        Name: ReadManyInventoryOutputsPolicy,
        Resource: Resource
    );
        ...
        options.AddPolicy(
            ...
            configurePolicy: builder =>
                builder.RequireProtectedResource(
                    resource: CreateOneInventoryOutputs.Resource,
                    scope: CreateOneInventoryOutputs.Scope
                )
        );
        options.AddPolicy(
            ...
            configurePolicy: builder =>
                builder.RequireProtectedResource(
                    resource: UpdateOneInventoryOutputs.Resource,
                    scope: UpdateOneInventoryOutputs.Scope
                )
        );
        options.AddPolicy(
            ...
            configurePolicy: builder =>
                builder.RequireProtectedResource(
                    resource: DeleteOneInventoryOutputs.Resource,
                    scope: DeleteOneInventoryOutputs.Scope
                )
        );
        options.AddPolicy(
            ...
            configurePolicy: builder =>
                builder.RequireProtectedResource(
                    resource: ReadOneInventoryOutputs.Resource,
                    scope: ReadOneInventoryOutputs.Scope
                )
        );
        options.AddPolicy(
            ...
            configurePolicy: builder =>
                builder.RequireProtectedResource(
                    resource: ReadManyInventoryOutputs.Resource,
                    scope: ReadManyInventoryOutputs.Scope
                )
        );
    };
}
