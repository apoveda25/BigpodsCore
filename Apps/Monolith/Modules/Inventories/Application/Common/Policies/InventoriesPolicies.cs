...
public sealed class InventoriesPolicies
{
    ...
    private static readonly IBasePolicy CreateOneInventories = new CreateOnePolicy(
        Name: CreateOneInventoriesPolicy,
        Resource: Resource
    );
    private static readonly IBasePolicy UpdateOneInventories = new UpdateOnePolicy(
        Name: UpdateOneInventoriesPolicy,
        Resource: Resource
    );
    private static readonly IBasePolicy DeleteOneInventories = new DeleteOnePolicy(
        Name: DeleteOneInventoriesPolicy,
        Resource: Resource
    );
    private static readonly IBasePolicy ReadOneInventories = new ReadOnePolicy(
        Name: ReadOneInventoriesPolicy,
        Resource: Resource
    );
    private static readonly IBasePolicy ReadManyInventories = new ReadManyPolicy(
        Name: ReadManyInventoriesPolicy,
        Resource: Resource
    );
        ...
        options.AddPolicy(
            ...
            configurePolicy: builder =>
                builder.RequireProtectedResource(
                    resource: CreateOneInventories.Resource,
                    scope: CreateOneInventories.Scope
                )
        );
        options.AddPolicy(
            ...
            configurePolicy: builder =>
                builder.RequireProtectedResource(
                    resource: UpdateOneInventories.Resource,
                    scope: UpdateOneInventories.Scope
                )
        );
        options.AddPolicy(
            ...
            configurePolicy: builder =>
                builder.RequireProtectedResource(
                    resource: DeleteOneInventories.Resource,
                    scope: DeleteOneInventories.Scope
                )
        );
        options.AddPolicy(
            ...
            configurePolicy: builder =>
                builder.RequireProtectedResource(
                    resource: ReadOneInventories.Resource,
                    scope: ReadOneInventories.Scope
                )
        );
        options.AddPolicy(
            ...
            configurePolicy: builder =>
                builder.RequireProtectedResource(
                    resource: ReadManyInventories.Resource,
                    scope: ReadManyInventories.Scope
                )
        );
    };
}
