...
public sealed record UpdateOneAttributeTypeCommand(
    IUpdateOneAttributeTypeDto AttributeTypeDto
) : IUpdateOneAttributeTypeCommand, IRequest<AttributeTypeModel>;
