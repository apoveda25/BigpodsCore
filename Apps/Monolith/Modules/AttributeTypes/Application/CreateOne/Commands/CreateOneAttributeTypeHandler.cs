...
) : IRequestHandler<CreateOneAttributeTypeCommand, AttributeTypeModel>
{
    ...
    private readonly ICreateOneAttributeTypeService _createOneAttributeTypeService = createOneAttributeTypeService;
    ...
    {
        var fetchResponse = await _createOneAttributeTypeService.ExecuteAsync(command: command, cancellationToken: token);
        ...
        await attributeTypesRepository.CreateOneAsync(entity: attributeTypeModel, cancellationToken: token);
