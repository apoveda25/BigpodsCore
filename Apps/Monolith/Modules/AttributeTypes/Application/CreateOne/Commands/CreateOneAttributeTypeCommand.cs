...
public sealed record CreateOneAttributeTypeCommand(
    ICreateOneAttributeTypeDto AttributeTypeDto
) : ICreateOneAttributeTypeCommand, IRequest<AttributeTypeModel>;
