...
public sealed class WarehousesPolicies
{
    ...
    private static readonly IBasePolicy CreateOneWarehouses = new CreateOnePolicy(
        Name: CreateOneWarehousesPolicy,
        Resource: Resource
    );
    private static readonly IBasePolicy UpdateOneWarehouses = new UpdateOnePolicy(
        Name: UpdateOneWarehousesPolicy,
        Resource: Resource
    );
    private static readonly IBasePolicy DeleteOneWarehouses = new DeleteOnePolicy(
        Name: DeleteOneWarehousesPolicy,
        Resource: Resource
    );
    private static readonly IBasePolicy ReadOneWarehouses = new ReadOnePolicy(
        Name: ReadOneWarehousesPolicy,
        Resource: Resource
    );
    private static readonly IBasePolicy ReadManyWarehouses = new ReadManyPolicy(
        Name: ReadManyWarehousesPolicy,
        Resource: Resource
    );
        ...
        options.AddPolicy(
            ...
            configurePolicy: builder =>
                builder.RequireProtectedResource(
                    resource: CreateOneWarehouses.Resource,
                    scope: CreateOneWarehouses.Scope
                )
        );
        options.AddPolicy(
            ...
            configurePolicy: builder =>
                builder.RequireProtectedResource(
                    resource: UpdateOneWarehouses.Resource,
                    scope: UpdateOneWarehouses.Scope
                )
        );
        options.AddPolicy(
            ...
            configurePolicy: builder =>
                builder.RequireProtectedResource(
                    resource: DeleteOneWarehouses.Resource,
                    scope: DeleteOneWarehouses.Scope
                )
        );
        options.AddPolicy(
            ...
            configurePolicy: builder =>
                builder.RequireProtectedResource(
                    resource: ReadOneWarehouses.Resource,
                    scope: ReadOneWarehouses.Scope
                )
        );
        options.AddPolicy(
            ...
            configurePolicy: builder =>
                builder.RequireProtectedResource(
                    resource: ReadManyWarehouses.Resource,
                    scope: ReadManyWarehouses.Scope
                )
        );
    };
}
