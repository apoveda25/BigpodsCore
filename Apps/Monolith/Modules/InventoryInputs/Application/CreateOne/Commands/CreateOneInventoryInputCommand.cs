...
public sealed record CreateOneInventoryInputCommand(ICreateOneInventoryInputDto InventoryInputDto)
    : ICreateOneInventoryInputCommand,
        IRequest<InventoryInputModel>;
