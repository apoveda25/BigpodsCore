...
public sealed class InventoryInputsPolicies
{
    ...
    private static readonly IBasePolicy CreateOneInventoryInputs = new CreateOnePolicy(
        Name: CreateOneInventoryInputsPolicy,
        Resource: Resource
    );
    private static readonly IBasePolicy UpdateOneInventoryInputs = new UpdateOnePolicy(
        Name: UpdateOneInventoryInputsPolicy,
        Resource: Resource
    );
    private static readonly IBasePolicy DeleteOneInventoryInputs = new DeleteOnePolicy(
        Name: DeleteOneInventoryInputsPolicy,
        Resource: Resource
    );
    private static readonly IBasePolicy ReadOneInventoryInputs = new ReadOnePolicy(
        Name: ReadOneInventoryInputsPolicy,
        Resource: Resource
    );
    private static readonly IBasePolicy ReadManyInventoryInputs = new ReadManyPolicy(
        Name: ReadManyInventoryInputsPolicy,
        Resource: Resource
    );
        ...
        options.AddPolicy(
            ...
            configurePolicy: builder =>
                builder.RequireProtectedResource(
                    resource: CreateOneInventoryInputs.Resource,
                    scope: CreateOneInventoryInputs.Scope
                )
        );
        options.AddPolicy(
            ...
            configurePolicy: builder =>
                builder.RequireProtectedResource(
                    resource: UpdateOneInventoryInputs.Resource,
                    scope: UpdateOneInventoryInputs.Scope
                )
        );
        options.AddPolicy(
            ...
            configurePolicy: builder =>
                builder.RequireProtectedResource(
                    resource: DeleteOneInventoryInputs.Resource,
                    scope: DeleteOneInventoryInputs.Scope
                )
        );
        options.AddPolicy(
            ...
            configurePolicy: builder =>
                builder.RequireProtectedResource(
                    resource: ReadOneInventoryInputs.Resource,
                    scope: ReadOneInventoryInputs.Scope
                )
        );
        options.AddPolicy(
            ...
            configurePolicy: builder =>
                builder.RequireProtectedResource(
                    resource: ReadManyInventoryInputs.Resource,
                    scope: ReadManyInventoryInputs.Scope
                )
        );
    };
}
