...
namespace Bigpods.Monolith.Migrations
{
    ...
    public partial class InitialMigration1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
                ...
                .CreateTable(
                    ...
                    columns: table => new
                    {
                        ...
                        Description = table
                            ...
                            .Annotation("MySql:CharSet", "utf8mb4"),
                        ValuePattern = table
                            .Column<string>(type: "text(65535)", nullable: false)
                            .Annotation("MySql:CharSet", "utf8mb4"),
                        MeasuringUnitPattern = table
                            .Column<string>(type: "text(65535)", nullable: false)
                            .Annotation("MySql:CharSet", "utf8mb4"),
                        ...
                        CreatedAtDatetime = table.Column<DateTime>(
                            type: "datetime(6)",
                            nullable: false
                        ),
                        UpdatedAtDatetime = table.Column<DateTime>(
                            type: "datetime(6)",
                            nullable: true
                        ),
                        DeletedAtDatetime = table.Column<DateTime>(
                            type: "datetime(6)",
                            nullable: true
                        ),
                        CreatedAtTimezone = table
                            .Column<string>(type: "varchar(36)", maxLength: 36, nullable: false)
                            .Annotation("MySql:CharSet", "utf8mb4"),
                        UpdatedAtTimezone = table
                            .Column<string>(type: "varchar(36)", maxLength: 36, nullable: true)
                            .Annotation("MySql:CharSet", "utf8mb4"),
                        DeletedAtTimezone = table
                            .Column<string>(type: "varchar(36)", maxLength: 36, nullable: true)
                            .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder
                .CreateTable(
                    ...
                    columns: table => new
                    {
                        ...
                        ContentType = table
                            .Column<string>(type: "varchar(127)", maxLength: 127, nullable: false)
                            .Annotation("MySql:CharSet", "utf8mb4"),
                        Extension = table
                            .Column<string>(type: "varchar(63)", maxLength: 63, nullable: false)
                            .Annotation("MySql:CharSet", "utf8mb4"),
                        IsDeleted = table.Column<bool>(
                            type: "tinyint(1)",
                            nullable: false,
                ...
                .CreateTable(
                    ...
                    columns: table => new
                    {
                        ...
                        MeasuringUnit = table
                            .Column<string>(type: "varchar(255)", maxLength: 255, nullable: false)
                            .Annotation("MySql:CharSet", "utf8mb4"),
                        AttributeTypeId = table.Column<Guid>(
                            type: "char(36)",
                            nullable: false,
                            collation: "utf8mb4_general_ci"
                        ),
            ...
            migrationBuilder
                .CreateTable(
                    ...
                    columns: table => new
                    {
                        ...
                        VariantId = table.Column<Guid>(
                            type: "char(36)",
                            nullable: false,
                            collation: "utf8mb4_general_ci"
                        ),
                        WarehouseId = table.Column<Guid>(
                            type: "char(36)",
                            nullable: false,
                            collation: "utf8mb4_general_ci"
                        ),
            ...
            migrationBuilder.CreateIndex(name: "IX_medias_Path", table: "medias", column: "Path");
            ...
            migrationBuilder.CreateIndex(name: "IX_variants_Sku", table: "variants", column: "Sku");
        ...
        {
            migrationBuilder.DropTable(name: "inventory_inputs");

            migrationBuilder.DropTable(name: "inventory_outputs");

            migrationBuilder.DropTable(name: "variants_on_attributes");

            migrationBuilder.DropTable(name: "variants_on_medias");
            ...
            migrationBuilder.DropTable(name: "attribute_types");
