...
public class InventoryOutputModelConfiguration : IEntityTypeConfiguration<InventoryOutputModel>
{
    public void Configure(EntityTypeBuilder<InventoryOutputModel> builder)
    {
        builder.ToTable(name: "inventory_outputs");
        ...
        builder
            .Property(propertyExpression: x => x.Comment)
            .IsRequired()
        ...
        builder
            .Property(propertyExpression: x => x.InventoryId)
            .UseCollation(collation: "utf8mb4_general_ci");
    }
}
